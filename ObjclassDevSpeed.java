...
public class ObjclassDevSpeed {
  ...
  public static class Reduce extends MapReduceBase implements Reducer<IntWritable, DoubleWritable, IntWritable, DoubleWritable> {
    private static DoubleWritable deviation = new DoubleWritable(1);	//point avg speeg 
  ...
  public static void main(String[] args) throws Exception {
    JobConf conf = new JobConf(ObjclassDevSpeed.class);
    conf.setJobName("ObjclassDevSpeed");
